    ...
    <div class="card">
        <div class="card-body py-0 px-1">
            <ul class="nav nav-tabs" id="brand-tabs" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link py-3 active" id="pending-tab" href="{{ route('adminpayment.pending') }}">Pending {{ $payments->count() }}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link py-3" id="completed-tab" href="{{ route('adminpayment.completed') }}">Completed {{ $completed }}</a>
                </li>
            </ul>
        </div>
