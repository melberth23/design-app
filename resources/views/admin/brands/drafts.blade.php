...
@section('title', 'Drafts Brand Profiles')
    ...
    <div class="container">
        ...
        @if ($brands->count() > 0)
            ...
            <div class="d-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800 page-heading">Draft brand profile</h1>
                <div class="actions d-flex align-items-center justify-content-end">
                    <div class="dropdown m-1">
                      ...
                      <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                        <a class="dropdown-item" href="{{ route('adminbrand.drafts.sort', ['customer_id' => $customer_id, 'type' => 'date', 'sort' => 'asc']) }}">Date added (Ascending)</a>
                        <a class="dropdown-item" href="{{ route('adminbrand.drafts.sort', ['customer_id' => $customer_id, 'type' => 'date', 'sort' => 'desc']) }}">Date added (Descending)</a>
                        <a class="dropdown-item" href="{{ route('adminbrand.drafts.sort', ['customer_id' => $customer_id, 'type' => 'name', 'sort' => 'asc']) }}">Name (A-Z)</a>
                        <a class="dropdown-item" href="{{ route('adminbrand.drafts.sort', ['customer_id' => $customer_id, 'type' => 'name', 'sort' => 'desc']) }}">Name (Z-A)</a>
                      </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card mb-4">
                <div class="card-body py-0 px-1">
                    <ul class="nav nav-tabs" id="brand-tabs" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link py-3 active" id="drafts-tab" href="{{ route('adminbrand.drafts', ['customer_id' => $customer_id]) }}">Drafts</a>
                        </li>
                        <li class="nav-item">
