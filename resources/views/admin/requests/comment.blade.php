...
<div class="container">
    ...
    <div class="card shadow mb-4">
                                ...
                                <div class="chat-body">
                                    <div class="chat-message">
                                        ...
                                        @foreach (App\Models\CommentsAssets::where('comments_id', $comment->id)->get() as $asset)
                                            <a href="{{ route('comment.download', ['asset' => $asset->id]) }}"><i class="fa fa-download" aria-hidden="true"></i> {{ __('File') }}</a>
                                        @endforeach
                                        </p>
        ...
        <div class="card-footer bg-light-custom">
            <form method="post" action="{{ route('adminrequest.addcomment') }}" enctype="multipart/form-data" >
                @csrf
