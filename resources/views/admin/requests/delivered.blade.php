            ...
            <div class="card-body py-0 px-1">
                <ul class="nav nav-tabs" id="brand-tabs" role="tablist">
                    ...
                    <li class="nav-item {{ (request()->is('admin/requests/delivered')) ? 'border-bottom' : '' }}">
                        <a class="nav-link py-3 {{ (request()->is('admin/requests/delivered')) ? 'active' : '' }}" id="delivered-tab" href="{{ route('adminrequest.delivered') }}">Completed {{ $requests->count() }}</a>
                    </li>
                </ul>
            </div>
                    ...
                    <div class="card-body">
                        <div class="min-height-600 d-flex align-items-center justify-content-center">
                            <div class="no-record py-4 text-center">
                                ...
                                <div class="pt-4">
                                    <h2>You have no requests completed.</h2>
                                </div>
                                <div class="pt-4">
